...
from .city_resolver import CityResolutionPipeline, CityResolutionConflict
from ..sources.geonames_bulk import CityNotFoundInRequestedState
...
def run_resolve_city(
    ...
    pipeline = CityResolutionPipeline()
    city_meta = pipeline.resolve(city_name, state_name, country_name)

...
from .classify import determine_primary_entity_type
    ...
    for r in accepted_records:
        ...
        p = Place(
            ...
            classification=PlaceClassification(
                ...
                primary_entity_type=r.get("primary_entity_type") or determine_primary_entity_type(r["category"], r.get("subcategory"), r.get("tags", []), r.get("name", "")),
